...
import { CartItem, Coupon, ShoppingCart } from '../../shared/models/cart';
...
export class CartService {
  ...
  totals = computed(() => {
    ...
    return { subtotal, deliveryFee, discount: discountValue, total: subtotal + deliveryFee - discountValue };
  });
